...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%baju%'"));
...
$tb_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%baju%' LIMIT $awalData, $jumlahDataPerHalaman");
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Baju</h3></div>
							<div class="panel-body">
								<center><h2 style="color: red;">Produk Baju</h2></center><br>
