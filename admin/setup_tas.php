...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%tas%'"));
...
$tl_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%tas%' LIMIT $awalData, $jumlahDataPerHalaman");
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<center><h2 style="color: red;">Produk Tas</h2></center><br>
