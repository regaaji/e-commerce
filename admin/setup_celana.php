...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%celana%'"));
...
$tb_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%celana%' LIMIT $awalData, $jumlahDataPerHalaman");

$jmlbarang = query("SELECT SUM(harga) as harga FROM tbl_barang WHERE nama LIKE '%baju%'");

$jmlbarang1 = query("SELECT SUM(harga) as harga FROM tbl_barang WHERE nama LIKE '%celana%'");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							<li>
								<i class="fa fa-male" style="padding-right: 10px"></i> Man
							</li>
							<li class="active">
								Celana
							</li>
             ...
             <div class="row">
                     	...
                     	<div class="thumbnail" style="background-color: light; border: 1px solid light; padding: 10px; box-shadow: 5px 10px 8px #CFCFCF; ">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Dana Baju</h5>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                     	<div class="thumbnail" style="background-color: light; border: 1px solid light; padding: 10px; box-shadow: 5px 10px 8px #CFCFCF; ">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Dana Celana</h5>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress" style="height: 5px;">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Celana</h3></div>

							<div class="panel-body">
								<center><h2 style="color: red;">Produk Celana</h2></center><br>
