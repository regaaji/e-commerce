...
$tbl_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%celana%'");
...
<html lang="en">
  ...
  <!-- page table -->
        <div class="row" style=" margin-left: 30px; margin-top: 50px;">
          ...
          <div class="col-lg-9">
           <div class="panel panel-primary">
              <div class="panel-heading">CELANA</div>
      ...
      <?php endforeach; ?>
          ...
          <div class="col-md-3" style="margin-left: 25px;  margin-top: -32%;">
           <div class="panel panel-primary">
